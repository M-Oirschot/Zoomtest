...
def Firstplayer(screen,width,height,player1,font):
  ...
  textButton4 = font.render("Do nothing",1,(0,0,0))
  time.sleep(0.5)
  if rolled == 1:
...
def Secondplayer (screen,width,height,player1,otherplayer,damage,font):
  errtext = font.render("You have too little condition", 1,(242,7,7))
  textButton4 = font.render("Do nothing",1,(0,0,0))
  bg = pygame.transform.scale(pygame.image.load("content\\bordspel_background.png"), (width,height))
  time.sleep(0.5)
...
def PlayerversusPlayer(screen,width,height,attacker,defender):
  ...
  screen.blit(square, (GetCenter(width,height,square)))
  pygame.display.flip()
  Attacker = Firstplayer(screen,width,height,attacker,pygame.font.Font(None, 40))
  Defender = Secondplayer(screen,width,height,defender,attacker,Attacker[0],pygame.font.Font(None, 40))
