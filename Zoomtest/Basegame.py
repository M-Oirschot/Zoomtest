...
def Menushit(screen,width,height,playerlist, playercount):
...
def Main(screen,width,height,playerslist,playercount):
    ...
    while True:
        ...
        print("")
        pygame.display.flip()
        Menushit(screen,width,height,playerslist,playercount)